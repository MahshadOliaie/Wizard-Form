    ...
    return (
        <>
            ...
            <form className="flex flex-col gap-7">
                ...
                })} type="text" placeholder="name" className="bg-gray-50 p-3 shadow-inner rounded-xl" />
                ...
                })} type="email" placeholder="example@email.com" className="bg-gray-50 p-3 shadow-inner rounded-xl" />
                ...
                })} type="password" placeholder="password (at least 8 characters)" className="bg-gray-50 p-3 shadow-inner rounded-xl" />
